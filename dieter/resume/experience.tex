...
{Feb 2026 - Present} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    \item {Planned and built on-premises AI factory infrastructure (Kubernetes, MinIO, LakeFS, PostgreSQL) to support cutting-edge ML research for humanoid robotics.}
    ...
    \item {Hiring and building an ML Ops team to own and evolve the hybrid compute platform end-to-end.}
...
{
  Apptronik is a humanoid robotics company building general-purpose robots designed to work alongside humans in industrial and commercial environments.
}
