...
%      These are large industrial machines containing a dozens of sensors and actuators to provide perfect growing conditions for raising crops in a scalable and environmentally friendly way.
    }

%---------------------------------------------------------
  \cventrywithsummary
    {Consulting Staff Software Engineer} % Job title
